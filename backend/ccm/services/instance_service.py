...
directories, allowing CCM to manage several Claude Code profiles.
"""
...
def switch_instance(path: str) -> dict[str, Any]:
    ...
    ccm_skill_providers_dir to point at the target instance.
    """
    ...
    settings.backup_dir = target / "backups" / "ccm"
    settings.ccm_skill_providers_dir = target / "ccm" / "skill-providers"
