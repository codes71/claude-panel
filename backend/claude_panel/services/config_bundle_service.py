...
from claude_panel.services import claude_md_service, mcp_service, skill_provider_service
from claude_panel.services.claude_json_service import set_mcp_servers


def export_bundle() -> dict:
    """Export a reproducible snapshot of key Claude Panel-managed config."""
